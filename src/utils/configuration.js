  ...
  constructor(args) {
    ...
    if (this.sourceType === 'api') {
      try {
        ...
        } else if (fs.existsSync(`${packageRoot}/src/api_configs/${args.source}.json`)) {
          // Fall back to defaults
          this.sourceTypeConfig = JSON.parse(fs.readFileSync(`${packageRoot}/src/api_configs/${args.source}.json`));
        } else if (args.source) {
    ...
    if (this.targetType === 'api') {
      try {
        ...
        } else if (fs.existsSync(`${packageRoot}/src/api_configs/${args.target}.json`)) {
          // Fall back to defaults
          this.targetTypeConfig = JSON.parse(fs.readFileSync(`${packageRoot}/src/api_configs/${args.target}.json`));
        } else {
